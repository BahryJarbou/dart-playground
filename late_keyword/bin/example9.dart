void main(List<String> args) {
  ...
  final doeFamily = WrongImpelementationOfFamily(members: [johnDoe, janeDoe]);
...
class WrongImpelementationOfFamily {
  final Iterable<Person> members;
  late int membersCount;

  WrongImpelementationOfFamily({required this.members}) {
